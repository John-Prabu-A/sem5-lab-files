...
class Vehicle {
	...
	public void start(String keyType) { System.out.println("Vehicle is Starting with a " + keyType + " key..."); }
}
...
class Car extends Vehicle {
	...
	public void setNumOfDoors(int n) { this.numOfDoors = n; }
...
class MotorCycle extends Vehicle {
	...
	public void setHasSideCar(boolean h) { this.hasSideCar = h; }
